    ...
    Column(modifier = modifier) {
        OutlinedTextField(
            ...
            trailingIcon = if (errorMessage == null) {
                ...
                {
                    Icon(
                        imageVector = CVPIcons.ErrorIcon, contentDescription = errorMessage
                    )
                }
            },
        ...
        errorMessage?.let {
            Text(
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(start = PaddingDim.LARGE, top = PaddingDim.EXTRA_SMALL),
                text = it,
    ...
    CVPTextField(
        ...
        trailingIcon = {
            IconButton(onClick = onHiddenChange) {
                val vector = if (hidden) CVPIcons.VisibilityOffIcon else CVPIcons.VisibilityIcon
